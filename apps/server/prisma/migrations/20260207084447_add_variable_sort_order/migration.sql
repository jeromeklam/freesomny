...
INSERT INTO "new_EnvironmentVariable" ("description", "environmentId", "id", "isSecret", "key", "scope", "type", "value") SELECT "description", "environmentId", "id", "isSecret", "key", "scope", "type", "value" FROM "EnvironmentVariable";
