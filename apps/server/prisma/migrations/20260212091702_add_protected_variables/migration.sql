...
INSERT INTO "new_EnvironmentVariable" ("category", "description", "environmentId", "id", "isSecret", "key", "scope", "sortOrder", "type", "value") SELECT "category", "description", "environmentId", "id", "isSecret", "key", "scope", "sortOrder", "type", "value" FROM "EnvironmentVariable";
